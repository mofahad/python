...
someone else who’s had that error and myou can probably fi gure out how to fi x it.
...
string may conatin format charecters, FOR EG %d , %s .
ou simply put the format-
ted variables in the string, and then a % (percent) character, followed by the variable. The only
catch is that if you want multiple formats in your string to print multiple variables, you need to
put them inside ( ) (parentheses) separated by , (commas).
...
in python 3 is renamed to input()
...
For raw_input, you can also put in a prompt to show to a person
...
we will cover one more input method you can use to pass variables to a script
(script being another name for your .py fi les). You know how you type python ex13.py to run
the ex13.py fi le? Well the ex13.py part of the command is called an “argument.” What we’ll do
...
mohammedfahadmushahidmm@gmail.com
